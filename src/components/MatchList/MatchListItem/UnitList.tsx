...
import itemsSet4Json from "../../../../public/json/items/items_set4.json";
import itemsSet4UpdateJson from "../../../../public/json/items/items_set4update.json";
import itemsSet5 from "../../../../public/json/items/items_set5.json";
...
const UnitTier = ({ tier }: { tier: number }): ReactElement | null => {
  if (tier === 2) {
    return (
      <UnitTierBlock>
        <img
          src={`${process.env.IMG_PUBLIC_PATH}/public/img/champions/TFT-StarSilver.svg`}
          alt="TFT-StarSilver"
        />
        <img
          src={`${process.env.IMG_PUBLIC_PATH}/public/img/champions/TFT-StarSilver.svg`}
  ...
  if (tier === 3) {
    return (
      <UnitTierBlock>
        <img
          src={`${process.env.IMG_PUBLIC_PATH}/public/img/champions/TFT-StarGold.svg`}
          alt="TFT-StarGold"
        />
        <img
          src={`${process.env.IMG_PUBLIC_PATH}/public/img/champions/TFT-StarGold.svg`}
      ...
      return css`
        &::before {
          ...
          background: url(${process.env
            .IMG_PUBLIC_PATH}/public/img/champions/TFT_Chosen_icon.svg);
          z-index: 1;
        }
      `;
    }
  ...
  ({ unit }: UnitListItemPropsT): ReactElement => {
    ...
    return (
      ...
      >
        ...
        <img
          src={`${process.env.IMG_PUBLIC_PATH}/public/img/champions/${unit.character_id}.png`}
